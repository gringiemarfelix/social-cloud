var baseUrl = 'https://projects.gringiemarfelix.com/socialcloud/public';
...
function comments(element, post, page = 1) {
    ...
    fetch(baseUrl + "/api/posts/comments?page=" + page, {
        method: "POST",
        headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
...
function submitComment(element) {
    ...
    if (comment.value != "") {
        ...
        fetch(baseUrl + "/api/posts/comments/submit", {
            method: "POST",
            headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
...
function deleteComment(element) {
    ...
    fetch(baseUrl + "/api/posts/comments/delete", {
        method: "POST",
        headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
...
function searchFriends(element){
    ...
    fetch(baseUrl + "/api/friends/search", {
        method: "POST",
        headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
