...
<div class="card border-0 shadow-sm rounded-3 my-3">
    <div class="card-body">
        <div class="card border-0">
            <div
                class="card-header border-0 bg-transparent d-flex justify-content-between pb-0">
                <div class="d-flex flex-grow-1">
                    ...
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="text-decoration-none h6 mb-0">{{$post->user->first_name}} {{$post->user->last_name}}</p>
