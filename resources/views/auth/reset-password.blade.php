            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="card rounded-3 border-0 shadow">
                        <form action="{{url('')}}/reset-password" method="POST" class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control rounded-3 border border-opacity-10" name="password_confirmation"
                            ...
                            <div class="mb-3">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary rounded-3 fs-5 fw-bold" type="submit">Reset Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
