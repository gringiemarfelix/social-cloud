            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="card rounded-3 border-0 shadow">
                        <div class="card rounded-3 border-0 shadow">
                            <form action="{{url('')}}/user/confirm-password" method="POST" class="card-body">
                                ...
                                @endif
                                @csrf
                                <p>Please confirm your password before continuing. We won't ask for your password again for a few hours.</p>
                                <div class="mb-3">
                                    <label for="password" class="form-label">Password</label>
                                    <input type="password" class="form-control rounded-3 border border-opacity-10" name="password"
                                ...
                                <div class="mb-3">
                                    <div class="d-grid gap-2">
                                        <button class="btn btn-primary rounded-3 fs-5 fw-bold" type="submit">Confirm Password</button>
                                    </div>
                                </div>
                            </form>
                        </div>
