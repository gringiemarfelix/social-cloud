                        ...
                        <form action="{{url('')}}/register" method="POST" class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-3 border border-opacity-10" name="first_name"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-3 border border-opacity-10" name="last_name"
                            ...
                            <div class="mb-3">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary rounded-3 fs-5 fw-bold" type="submit">Create Account</button>
                                </div>
                            </div>
                        </form>
                    </div>
