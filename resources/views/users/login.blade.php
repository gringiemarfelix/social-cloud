                ...
                <div class="col-12 col-lg-4">
                    <div class="card rounded-3 border-0 shadow">
                        <form action="{{url('')}}/login" method="POST" class="card-body">
                            @if (session()->has('message') || session()->has('status') || session()->has('attempts'))
                            ...
                            <div class="mb-3">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary rounded-3 fs-5 fw-bold" type="submit">Log In</button>
                                </div>
                            ...
                            <div class="mb-3">
                                <div class="d-grid gap-2">
                                    <a href="{{url('')}}/register" class="btn btn-secondary rounded-3 fs-5 fw-bold">Create Account</a>
                                </div>
                            </div>
                        </form>
                    </div>
