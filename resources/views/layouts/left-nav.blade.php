        ...
        <div class="col-lg-2 shadow-sm position-sticky d-none d-lg-block"
            ...
            <ul class="nav flex-column mt-3 mx-1 position-sticky" style="top: 77px;">
                ...
                <li class="nav-item">
                    <a class="nav-link py-3 {{ (request()->is('friends*')) ? $active : $item }}" href="{{url('')}}/friends">
                        ...
                        @php
                            $requests = auth()->user()->friend_requests()->count();
                            $badge = null;
                            if($requests){
                                $badge = "<span class=\"ms-1 badge rounded-circle bg-secondary text-danger\">$requests</span>";
                            }
                        @endphp
                        <span class="h6 mb-0 ms-2">Friends {!! $badge !!}</span>
                    </a>
                </li>
                {{-- <li class="nav-item">
